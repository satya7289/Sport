...
class CheckoutView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            self.template_name,
            {"sports": sports, "items": items, "students": students},
        )
        ...
        if request.method == "POST":
            ...
            for i in number_of_items:
                ...
                item = Item.objects.filter(
                    name=item_name, brand=brand, quality=quality, sport_type=sport
                ).first()
                ...
                list_of_items.append([sport_name, item_name, brand, quality, quantity])
