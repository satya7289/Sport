...
class ItemListView(View):
    ...
    def pagination(self, object,id,sport):
        ...
        return render(self.request,self.template_name,{'items':items,'id':id,'sport':sport})
...
class ItemCreateView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.method=="POST":
            ...
            item    = Item(name=name,brand=brand,quality=quality,available=quantity,quantity=quantity,description=description,sport_type=sport,created_at=D.datetime.now().date())
            item.save()
            return redirect('list_item',id)
    ...
    def get(self,request,*args,**kwargs):
        if request.method=="GET":
            ...
            try:
                ...
                return render(request,self.template_name,{ 'item':item, 'sport_pk':sport_pk})
